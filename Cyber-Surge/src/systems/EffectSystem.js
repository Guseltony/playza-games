// Effect System - Particle effects, trails, screen shake, and game juice
...
export class EffectSystem {
    ...
    addNearMiss() {
        this.engine.cameraSystem.nearMissEffect();
    }
    ...
    addTransition(biome) {
        ...
        const color = colors[biome] || 0xffffff;
        
        for (let i = 0; i < 40; i++) {
            const pos = this.engine.player.player.position.clone();
            pos.x = (Math.random() - 0.5) * 20;
            pos.z = pos.z + 20 + Math.random() * 30;
